  ...
  outputs = { self, nixpkgs, ... }@inputs:
    ...
    in {
      ...
      devShells = forAllSystems (system:
        ...
        in {
          default =
            pkgs.mkShell { buildInputs = with pkgs; [ nixos-rebuild ]; };
        });
      ...
      nixosConfigurations = {
        ...
        base = nixpkgs.lib.nixosSystem {
          system = "x86_64-linux";
          modules = [ ./hardware/hcloud.nix ./configuration.nix ];
        };

        vultr-base = nixpkgs.lib.nixosSystem {
          system = "x86_64-linux";
          modules = [ ./hardware/vultr.nix ./configuration.nix ];
        };

        test = nixpkgs.lib.nixosSystem {
          system = "x86_64-linux";
          modules =
            [ ./hardware/hcloud.nix ./configuration.nix ./configs/test.nix ];
        };
